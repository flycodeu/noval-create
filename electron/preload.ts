...
const api = {
  ...
  character: {
    ...
    startAutoGenerate: (novelId: number, opts: unknown) => ipcRenderer.invoke('character:startAutoGenerate', novelId, opts),
    getAutoGenerateStatus: (taskId: number) => ipcRenderer.invoke('character:getAutoGenerateStatus', taskId),
    getLatestAutoGenerateTask: (novelId: number) => ipcRenderer.invoke('character:getLatestAutoGenerateTask', novelId),
    resumeAutoGenerate: (taskId: number) => ipcRenderer.invoke('character:resumeAutoGenerate', taskId),
  ...
  timeline: {
    ...
    startAutoGenerate: (novelId: number, options?: unknown) => ipcRenderer.invoke('timeline:startAutoGenerate', novelId, options),
    getAutoGenerateStatus: (taskId: number) => ipcRenderer.invoke('timeline:getAutoGenerateStatus', taskId),
    getLatestAutoGenerateTask: (novelId: number) => ipcRenderer.invoke('timeline:getLatestAutoGenerateTask', novelId),
    resumeAutoGenerate: (taskId: number) => ipcRenderer.invoke('timeline:resumeAutoGenerate', taskId),
  ...
  item: {
    ...
    startAutoGenerate: (novelId: number, options?: unknown) => ipcRenderer.invoke('item:startAutoGenerate', novelId, options),
    getAutoGenerateStatus: (taskId: number) => ipcRenderer.invoke('item:getAutoGenerateStatus', taskId),
    getLatestAutoGenerateTask: (novelId: number) => ipcRenderer.invoke('item:getLatestAutoGenerateTask', novelId),
    resumeAutoGenerate: (taskId: number) => ipcRenderer.invoke('item:resumeAutoGenerate', taskId),
  ...
  thread: {
    ...
    getForeshadowSnapshot: (novelId: number, chapterNum?: number) => ipcRenderer.invoke('thread:getForeshadowSnapshot', novelId, chapterNum),
    generate: (novelId: number, options?: StoryThreadBatchGenerateOptions) => ipcRenderer.invoke('thread:generate', novelId, options),
    startAutoGenerate: (novelId: number, options?: StoryThreadBatchGenerateOptions) => ipcRenderer.invoke('thread:startAutoGenerate', novelId, options),
    getAutoGenerateStatus: (taskId: number) => ipcRenderer.invoke('thread:getAutoGenerateStatus', taskId),
    getLatestAutoGenerateTask: (novelId: number) => ipcRenderer.invoke('thread:getLatestAutoGenerateTask', novelId),
    resumeAutoGenerate: (taskId: number) => ipcRenderer.invoke('thread:resumeAutoGenerate', taskId),
  ...
  faction: {
    list: (novelId: number) => ipcRenderer.invoke('faction:list', novelId),
    query: (filters: unknown) => ipcRenderer.invoke('faction:query', filters),
    getStats: (filters: unknown) => ipcRenderer.invoke('faction:getStats', filters),
    get: (id: number) => ipcRenderer.invoke('faction:get', id),
    search: (novelId: number, keyword?: string, limit?: number) => ipcRenderer.invoke('faction:search', novelId, keyword, limit),
    getGraph: (filters: unknown) => ipcRenderer.invoke('faction:getGraph', filters),
    create: (novelId: number, data: unknown) => ipcRenderer.invoke('faction:create', novelId, data),
    update: (id: number, data: unknown) => ipcRenderer.invoke('faction:update', id, data),
    delete: (id: number) => ipcRenderer.invoke('faction:delete', id),
    batchGenerate: (novelId: number, opts: unknown) => ipcRenderer.invoke('faction:batchGenerate', novelId, opts),
    startAutoGenerate: (novelId: number, opts: unknown) => ipcRenderer.invoke('faction:startAutoGenerate', novelId, opts),
    getAutoGenerateStatus: (taskId: number) => ipcRenderer.invoke('faction:getAutoGenerateStatus', taskId),
    getLatestAutoGenerateTask: (novelId: number) => ipcRenderer.invoke('faction:getLatestAutoGenerateTask', novelId),
    resumeAutoGenerate: (taskId: number) => ipcRenderer.invoke('faction:resumeAutoGenerate', taskId),
    resolveNameOptions: (novelId: number) => ipcRenderer.invoke('faction:resolveNameOptions', novelId),
  },
  glossary: {
    list: (novelId: number) => ipcRenderer.invoke('glossary:list', novelId),
    query: (filters: unknown) => ipcRenderer.invoke('glossary:query', filters),
    getStats: (filters: unknown) => ipcRenderer.invoke('glossary:getStats', filters),
    get: (id: number) => ipcRenderer.invoke('glossary:get', id),
    search: (novelId: number, keyword?: string, limit?: number) => ipcRenderer.invoke('glossary:search', novelId, keyword, limit),
    create: (novelId: number, data: unknown) => ipcRenderer.invoke('glossary:create', novelId, data),
    update: (id: number, data: unknown) => ipcRenderer.invoke('glossary:update', id, data),
    delete: (id: number) => ipcRenderer.invoke('glossary:delete', id),
  },
  sceneTemplate: {
    list: (filters: unknown) => ipcRenderer.invoke('sceneTemplate:list', filters),
    query: (filters: unknown) => ipcRenderer.invoke('sceneTemplate:query', filters),
    getStats: (filters: unknown) => ipcRenderer.invoke('sceneTemplate:getStats', filters),
    get: (id: number) => ipcRenderer.invoke('sceneTemplate:get', id),
    search: (novelId: number, genreId?: number, keyword?: string, limit?: number) => ipcRenderer.invoke('sceneTemplate:search', novelId, genreId, keyword, limit),
    create: (data: unknown) => ipcRenderer.invoke('sceneTemplate:create', data),
    update: (id: number, data: unknown) => ipcRenderer.invoke('sceneTemplate:update', id, data),
    delete: (id: number) => ipcRenderer.invoke('sceneTemplate:delete', id),
  },
  subplot: {
    generate: (request: unknown) => ipcRenderer.invoke('subplot:generate', request),
    startAutoGenerate: (request: unknown) => ipcRenderer.invoke('subplot:startAutoGenerate', request),
    getAutoGenerateStatus: (taskId: number) => ipcRenderer.invoke('subplot:getAutoGenerateStatus', taskId),
    getLatestAutoGenerateTask: (novelId: number) => ipcRenderer.invoke('subplot:getLatestAutoGenerateTask', novelId),
    resumeAutoGenerate: (taskId: number) => ipcRenderer.invoke('subplot:resumeAutoGenerate', taskId),
  },
